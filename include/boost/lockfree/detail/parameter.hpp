...
struct extract_capacity
{
    ...
    typedef
        typename mpl::if_c< has_capacity, typename has_arg< bound_args, tag::capacity >::type, mpl::size_t< 0 > >::type
            capacity_t;
...
struct extract_allocator
{
    ...
    typedef
        typename mpl::if_c< has_allocator,
                            typename has_arg< bound_args, tag::allocator >::type,
                            boost::alignment::aligned_allocator< T, BOOST_LOCKFREE_CACHELINE_BYTES > >::type allocator_arg;
